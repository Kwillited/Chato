      ...
      <div class="flex-1 p-2">
        ...
        <div v-if="activePanel === 'context'" class="flex flex-col">
          ...
          <div class="flex-1 flex flex-col">
            ...
            <Card class="h-[calc(100vh-360px)] overflow-hidden flex flex-col mb-4">
            ...
            <Card class="flex-1 overflow-hidden flex flex-col">
              ...
              <div v-if="activePromptTab === 'system'" class="flex-1 flex flex-col space-y-3 pt-2 pb-4">
                <textarea
                  ...
                  class="flex-1 w-full text-xs p-3 border border-gray-200 dark:border-dark-border rounded-lg bg-transparent text-gray-900 dark:text-white resize-none focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all duration-200 shadow-sm"
