    ...
    extend: {
      colors: {
        1:{
          ...
          primaryAccent: '#333333', // 深灰色 (#333333) - 按钮点缀
        },
        ...
        'dark-600': '#334155', // 中等深灰色背景
        'dark-500': '#64748b'  // 浅深灰色背景
